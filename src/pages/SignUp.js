                    ...
                    <View style={styles.agreementContainer}>
                      <View style={styles.agreementView}>
                        ...
                        <View style={{ marginTop: 8 }}>
                          <Text>
                            <CustomModalView labelText="Kullanıcı Sözleşmesi">
                      ...
                      <View style={styles.agreementView}>
                        ...
                        <View style={{ marginTop: 8 }}>
                          <Text>
                            <CustomModalView labelText="KVKK Aydınlatma Metni">
                              KVKK aydınlatma formunu{" "}
                            </CustomModalView>
                      ...
                      <View style={styles.agreementView}>
                        <AgreementCheckBox
                          isChecked={values.dataAgreement}
                          onClick={() => {
                            setFieldValue(
                              "dataAgreement",
                              !values.dataAgreement
                            );
                          }}
                        />
                        ...
                        <View style={{ marginTop: 8 }}>
                          <Text>
                            <CustomModalView labelText="Verilerin İşlenmesi Sözleşmesi">
                              Verilerimin işlenmesini{" "}
                            </CustomModalView>
